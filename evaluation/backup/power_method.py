...
if __name__ == '__main__':
    ...
    print iterator_values1
    print iterator_values2
    # print iterator_values3
    print iterator_values4
    ...
    #     y_values6.append(iterator_values6[order])
        order += 1
    #
    pylab.plot(x_values, y_values1, 'rs', linewidth=1, linestyle="-", label=u"随机")
    pylab.plot(x_values, y_values2, 'ks', linewidth=1, linestyle="-", label=u"不可约(α=0.8)")
    # pylab.plot(x_values, y_values3, 'bs', linewidth=1, linestyle="-", label=u"shifted(α=0.1)")
    pylab.plot(x_values, y_values4, 'ys', linewidth=1, linestyle="-", label=u"no shifted")
